...
import { TextEditorsIDELessonsList } from './text-editors-ide-lessons-list';
...
export default async function Page({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  return (
    <ADRCategoryPage
      title={globalDict['subcategory.text-editors-ide'] ?? 'Text Editors, IDE'}
      publishedDate={globalDict['3d-printer-adr.published'] ?? 'Published April 2026'}
      description={<></>}
      adrsList={TextEditorsIDELessonsList}
